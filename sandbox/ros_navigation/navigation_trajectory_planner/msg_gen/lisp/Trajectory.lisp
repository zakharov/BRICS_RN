...
(cl:in-package navigation_trajectory_planner-msg)
...
(cl:defmethod cl:initialize-instance :after ((m <Trajectory>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Trajectory)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name navigation_trajectory_planner-msg:<Trajectory> is deprecated: use navigation_trajectory_planner-msg:Trajectory instead.")))

(cl:ensure-generic-function 'header-val :lambda-list '(m))
(cl:defmethod header-val ((m <Trajectory>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader navigation_trajectory_planner-msg:header-val is deprecated.  Use navigation_trajectory_planner-msg:header instead.")
  (header m))

(cl:ensure-generic-function 'trajectory-val :lambda-list '(m))
(cl:defmethod trajectory-val ((m <Trajectory>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader navigation_trajectory_planner-msg:trajectory-val is deprecated.  Use navigation_trajectory_planner-msg:trajectory instead.")
  (trajectory m))
