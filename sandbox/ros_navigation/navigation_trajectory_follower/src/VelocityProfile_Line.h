...
#ifndef VELOCITYPROFILE_LINE_H
#define	VELOCITYPROFILE_LINE_H
...
/**
     ...
     * @ingroup Motion
     */
    class VelocityProfile_Line : public VelocityProfile {
    ...
    public:
        ...
        VelocityProfile_Line(double _maxvel = 0, double _maxacc = 0);
